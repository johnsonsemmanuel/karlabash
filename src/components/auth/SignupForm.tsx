  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-12">
      ...
      <p className="text-sm text-charcoal mb-8">
        Join Ghana&apos;s creative marketplace
      </p>
      ...
      >
        <div className="mb-4">
          ...
          <div className="flex items-center border border-line rounded-[7px] bg-white focus-within:border-red-karlabash transition-colors">
            <User size={16} className="text-charcoal ml-3" />
            <input
              type="text"
              value={fullName}
        ...
        <p className="text-xs text-charcoal mb-6">
          ...
          <Link to="/terms" className="text-red-karlabash hover:underline">
            Terms
          </Link>{" "}
          and{" "}
          <Link to="/privacy" className="text-red-karlabash hover:underline">
            Privacy Policy
          </Link>
        </p>
      ...
      <p className="text-sm text-charcoal text-center mt-6">
        ...
        <Link to="/login" className="text-red-karlabash font-semibold hover:underline">
          Log in
        </Link>
      </p>
    </div>
