...
const marketplaceLinks = [
  ...
  { to: "/show-love", label: "Show Love" },
];

const creatorLinks = [
  { to: "/sell", label: "Sell on Karlabash" },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-2">
            <Link
              to="/"
              className="font-manrope font-extrabold text-xl text-white"
            >
              Karlabash
            </Link>
            <p className="text-sm text-white/50 mt-2">
              Ghana's marketplace for books, events, and creators
            </p>
        ...
        <div className="border-t border-white/10 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-white/30">
            &copy; 2026 Karlabash. All rights reserved.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-2">
            {paymentMethods.map((method) => (
              <span
                key={method}
                className="bg-white/10 text-white/60 text-[10px] font-semibold px-2.5 py-1 rounded-[4px]"
              >
                {method}
              </span>
            ))}
